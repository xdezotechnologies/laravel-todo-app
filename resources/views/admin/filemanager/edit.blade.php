                  ...
                  <form action="{{route('filemanager.update',$filemanager->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="{{$filemanager->title}}">
                      </div>
                      <div class="form-group">
                      ...
                      Preview:
                      <img src="{{asset('uploads/files/'.$filemanager->link)}}" alt="" height="150px;" width="150px;">
                    </div>
                    <!-- /.card-body -->
